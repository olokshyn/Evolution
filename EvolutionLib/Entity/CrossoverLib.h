...
inline double Tnorm(double q, double x, double y) {
    LOG_ASSERT(q >= 0 && q <= 1);
    LOG_ASSERT(x >= 0 && x <= 1);
    LOG_ASSERT(y >= 0 && y <= 1);
...
inline double Tconorm(double q, double x, double y) {
    LOG_ASSERT(q >= 0 && q <= 1);
    LOG_ASSERT(x >= 0 && x <= 1);
    LOG_ASSERT(y >= 0 && y <= 1);
...
inline double ParAvgSqrt(double q, double x, double y) {
    LOG_ASSERT(x >= 0 && x <= 1);
    LOG_ASSERT(y >= 0 && y <= 1);
    return pow((pow(x, q) + pow(y, q)) / 2, 1 / q);
}

inline double ParAvgLinear(double q, double x, double y) {
    LOG_ASSERT(q >= 0 && q <= 1);
    LOG_ASSERT(x >= 0 && x <= 1);
    LOG_ASSERT(y >= 0 && y <= 1);
    return q * x + (1 - q) * y;
...
inline double scale_exploration(size_t gen_numb, size_t max_generations_count) {
    return 1.0 / gen_numb;
}

inline double scale_exploitation_plus(size_t gen_numb,
                                      size_t max_generations_count) {
    return 1 + log(max_generations_count / (double)gen_numb);
}

inline double scale_exploitation_minus(size_t gen_numb,
                                       size_t max_generations_count) {
    return 1 + log((double)gen_numb / max_generations_count);
}

inline double DynamicBase(size_t gen_numb, size_t max_generations_count,
...
inline double dcF(size_t gen_numb, size_t max_generations_count,
                  double c1, double c2, double a, double b) {
...
inline double dcS(size_t gen_numb, size_t max_generations_count,
                  double c1, double c2, double a, double b) {
    return DynamicBase(gen_numb, max_generations_count,
                       c1, c2, a, b,
...
inline double dcMplus(size_t gen_numb, size_t max_generations_count,
                      double c1, double c2, double a, double b) {
    return DynamicBase(gen_numb, max_generations_count,
                       c1, c2, a, b,
...
inline double dcMminus(size_t gen_numb, size_t max_generations_count,
                       double c1, double c2, double a, double b) {
    return DynamicBase(gen_numb, max_generations_count,
                       c1, c2, a, b,
...
inline double dbcM(size_t gen_numb, size_t max_generations_count,
                   double c1, double c2,
